	...
	public static void main(String[] args) {
        ...
        // 结果集
           ...
           while(rs.next()) {
            ...
            district = new String(rs.getString("district").getBytes("UTF-8"));
         //   System.out.println(province);
          
            	  System.out.println(district);
            	  String sql11="select id from tennis_district where districtName=?;";
            	  
            	  PreparedStatement ps=(PreparedStatement) conn.prepareStatement(sql11);
            	  ps.setString(1, district);
            	  ResultSet rs2=ps.executeQuery();
            	  if(rs2.next()){
            		  String districtid=rs2.getString("id");
                	  System.out.println(districtid);
                      String sql2="update tennis_court set district_model='"+districtid+"' where id="+id;
